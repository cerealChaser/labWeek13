		...
		translate.createData();
				...
				try
				{
					...
					while (true) {
						...
						// create input stream for read the text input
						// from client request on network
						DataInputStream inputStream = 
								new DataInputStream(
										clientSocket.getInputStream());
						
						// read the text input, and the choice of 
						...
						System.out.println("Data sent to the client:"
								+ " " + text + " is translated to " + language);
						System.out.println("Accepted connection "
								+ "to from the " + "client. Total request = " + 
								++totalRequest);
