package clientconsolebasedtexttranslation;
 ...
 * where client enter the input English text for translation 
 * to selected target language via button.
...
public class ClientConsoleFrame  extends JFrame implements ActionListener{
	...
	/**
	 * change the text to the translated text
	 * 
	 * @param translated
	 */
	 ...
	 * Each button will do action of text translation
	 *  to different target language
	 *  
