package serverconsolebasedtexttranslation;
 ...
 * and the selected target language (Malay, Arabic and Korean) 
 * from client request.
 * 
...
public class TextTranslator {
	...
	public String translateToArb(String text)
	{
		...
		try
		{
			...
			// Conditions to parse the correspond text to the respective
			// variable based on English text input
			if(text.toUpperCase().equals("GOOD MORNING"))
			{
				translated = morning;
			}
	...
	public String translateToKrn(String text)
	{
		...
		try
		{
			...
			// Conditions to parse the correspond text 
			// to the respective variable based on English text input
			if(text.toUpperCase().equals("GOOD MORNING"))
			{
				translated = morning;
			}
