package ex6clienttexttranslationapp;
...
public class ClientTextTranslationApp{
	...
	{	
		...
		if(choice == 1)
		{
			  // write input for text to be translated and the choice 
			  // of target language to the stream
			  dataoutputStream.writeUTF(line);
			  dataoutputStream.writeInt(choice);
			  
			  // read the Malay translated text from the stream after 
			  // translation from server is done
		...
		{
			  // write input for text to be translated 
			  // and the choice of target language to the stream
			  dataoutputStream.writeUTF(line);
			  dataoutputStream.writeInt(choice);
			  
			  // read the Arabic translated text from the stream 
			  // after translation from server is done
			  String translated = datainputstream.readUTF();
			  
			  // display the original text and its Arabic translated text
			  System.out.println("The text: " + line);
			  System.out.println("The text translated in Arabic: " 
					  											+ translated);
		}
		...
		else if(choice == 3)
		{
			  ...
			  // read the Korean translated text from the stream
			  // after translation from server is done
			  String translated = datainputstream.readUTF();
			  
			  // display the original text and its Korean translated text
			  System.out.println("The text: " + line);
			  System.out.println("The text translated in Korean: " 
					  											+ translated);
		}
